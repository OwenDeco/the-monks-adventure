...
public class EntityManager {
	...
	private ArrayList<Entity> entities, respawnEntities;
	private int count =0;
	...
	public void addRespawnEntity(Entity e) {
		respawnEntities.add(e);
	}

	public void removeRespawnEntity(Entity e) {
		respawnEntities.remove(e);
	}

	public void clearEntity(ArrayList<Entity> entities) {
		entities.clear();
	}
	// getters setters
