...
public class Snake extends Creature {
	...
	public Snake(Handler handler, float x, float y, int health, int direction) {
		...
		animUp = new Animation(150, Assets.snake_up);
		animDown = new Animation(150, Assets.snake_down);
		animLeft = new Animation(150, Assets.snake_left);
		animRight = new Animation(150, Assets.snake_right);
	...
	public void render(Graphics g) {
		if (System.currentTimeMillis() - startTimer >= 5000) {
			...
			yMove = 0;
			if (tempDir == 0) {
				g.drawImage(Assets.snake_up[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			} else if (tempDir == 1) {
				g.drawImage(Assets.snake_down[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			} else if (tempDir == 2) {
				g.drawImage(Assets.snake_right[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			} else {
				g.drawImage(Assets.snake_left[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			}
		}
