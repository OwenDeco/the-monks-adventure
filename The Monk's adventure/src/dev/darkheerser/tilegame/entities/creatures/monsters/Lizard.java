...
public class Lizard extends Creature {
	...
	public Lizard(Handler handler, float x, float y, int health, int direction) {
		...
		animUp = new Animation(250, Assets.lizard_up);
		animDown = new Animation(250, Assets.lizard_down);
		animLeft = new Animation(250, Assets.lizard_left);
		animRight = new Animation(250, Assets.lizard_right);
	...
	public void render(Graphics g) {
		if (System.currentTimeMillis() - startTimer >= 5000) {
			...
			yMove = 0;
			if (tempDir == 0) {
				g.drawImage(Assets.lizard_up[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			} else if (tempDir == 1) {
				g.drawImage(Assets.lizard_down[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			} else if (tempDir == 2) {
				g.drawImage(Assets.lizard_right[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			} else {
				g.drawImage(Assets.lizard_left[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			}
		}
