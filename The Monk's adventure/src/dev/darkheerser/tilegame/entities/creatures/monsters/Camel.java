...
public class Camel extends Creature {
	...
	public Camel(Handler handler, float x, float y, int health, int direction) {
		...
		animUp = new Animation(350, Assets.camel_up);
		animDown = new Animation(350, Assets.camel_down);
		animLeft = new Animation(350, Assets.camel_left);
		animRight = new Animation(350, Assets.camel_right);
	...
	public void render(Graphics g) {
		if (System.currentTimeMillis() - startTimer >= 5000) {
			...
			yMove = 0;
			if (tempDir == 0) {
				g.drawImage(Assets.camel_up[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			} else if (tempDir == 1) {
				g.drawImage(Assets.camel_down[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			} else if (tempDir == 2) {
				g.drawImage(Assets.camel_right[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			} else {
				g.drawImage(Assets.camel_left[0], (int) (x - handler.getCamera().getxOffset()),
						(int) (y - handler.getCamera().getyOffset()), width, height, null);
			}
		}
